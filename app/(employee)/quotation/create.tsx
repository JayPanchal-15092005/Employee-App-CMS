import { LOGO_BASE64, STAMP_BASE64 } from "@/constants/Images";
        ...
        <body>
          ...
          <div class="header-container">
            <div class="logo-section">
              <img src="${LOGO_BASE64}" style="width: 100px; height: auto;" />
            </div>
          ...
          <div style="display: flex; align-items: center; margin-top: 40px; gap: 30px;">
            ...
            <div>
              <img src="${STAMP_BASE64}" style="width: 110px; height: auto; opacity: 0.9;" />
            </div>
          </div>
