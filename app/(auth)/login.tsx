...
// 🟢 NEW WAY: Import getAuth, GoogleAuthProvider, and signInWithCredential
import {
  getAuth,
  GoogleAuthProvider,
...
export default function LoginScreen() {
  ...
  async function onGoogleButtonPress() {
    ...
    try {
      ...
      // 3. Create a Google credential with the token (🟢 UPDATED)
      const googleCredential = GoogleAuthProvider.credential(idToken);

      // 4. Sign-in the user with the credential
      // (🟢 NEW WAY: Pass firebaseAuth to signInWithCredential)
